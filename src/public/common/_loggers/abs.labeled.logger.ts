import {Component} from "@ts-server/di/decorators/class.component.decorator";
import {Inject} from "@ts-server/di/decorators/prop.inject.decorator";
import {Provider} from "@ts-server/di/models/abs.provider";
import Logger from "./abs.logger";
import LoggerModule from "@ts-server/logger.module";

/**
 * Implementation of logger that displays a label as first parameter.
 */
@Component(LoggerModule)
abstract class LabeledLogger extends Logger {
